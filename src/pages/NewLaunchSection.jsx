      ...
      <div className="w-full max-w-8xl relative">
        ...
        <div className="mt-10">
          <div className="lg:absolute relative inset-0 flex items-center justify-center z-10 px-6 lg:mt-16">
            ...
            <button
              onClick={scrollLeft}
              className="absolute left-0 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 text-black p-3 rounded-full shadow-lg z-20 transition"
            >
            ...
            <button
              onClick={scrollRight}
              className="absolute right-0 top-1/2 -translate-y-1/2 bg-white/30 hover:bg-white/50 text-black p-3 rounded-full shadow-lg z-20 transition"
            >
