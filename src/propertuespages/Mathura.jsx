        ...
        <>
            ...
            <div className="flex items-center justify-center z-10 px-6 ">
                <div className="grid grid-cols-1  gap-6 w-full max-w-8xl mt-16">
                    ...
                    <div>
                        <h3 className='text-3xl lg:text-5xl font-semibold'>Residential Plot Project – SHRI SAYA GREENS ACRES</h3>
                    </div>

                    <div>
                        <p className='text-xl 2xl:text-2xl'><span className='font-bold'>Location —</span>  MART VIRANDAWAN</p>
                        <p className='text-xl 2xl:text-2xl'> <span className='font-bold'> Project Name </span> SHRI SHAYA GREANS</p>
                    </div>

                    <div>
                        <p className='text-xl 2xl:text-2xl'><span className='font-bold'>Plot Size Available: </span>  111-460/ sqyrd </p>
                    </div>

                    <div>
                        <p className='text-xl 2xl:text-2xl'><span className='font-bold'>Rate:  </span>  ₹. 22500/ sqryd </p>
                    </div>

                    <div>
                        <p className='text-xl 2xl:text-2xl'><span className='font-bold'> Registry & Mutation:  </span>  Ready – 100% Legal </p>
                    </div>

                    <div>
                        <p className='text-xl 2xl:text-2xl'><span className='font-bold'>Road Size: </span>  25 ft. & 30 ft. wide </p>
                    </div>



                    <div>
                        <h3 className='text-3xl lg:text-5xl font-semibold'>Facilities: —</h3>
                    </div>
                    ...
                    <div>
                        <p className='text-xl 2xl:text-2xl'>🔐 Booking Amount: ₹51,000 only</p>
                    </div>

                    <div>
                        <p className='text-xl 2xl:text-2xl'>📍 Google Location & Brochure Available on Request</p>
                    </div>
                </div>
            </div>
        </>
